...
const myMovies = [
    ...
    },
    {
        ...
        "overview": "On Planet K, unknown to anyone on Earth, three teenagers chosen by fate can travel back and forth twenty years into the future by sneezing. In the face of a shocking plot to destroy the world, they have nothing but crystal-clear stupidity and single-digit combat power, so how can they transform into heroes and fight against the super-villainous villains who are intent on destroying the world? How can they turn into heroes and fight against the super baddest villains intent on destroying the world? The \"King Bomb\" brothers, who look like grown-ups but have minds like no other, will save the future on behalf of the K-Star!",
        "popularity": 1125.171,
    ...
    },
    {
        ...
        "overview": "Johnny and Clyde are two serial killers who are madly in love and on an endless crime spree. Alana (Megan Fox) is the confident and cunning owner of a prosperous casino that generates tens of millions of dollars each year. Johnny and Clyde decide to assemble a ragtag group of criminals and misfits to steal from Alana's casino and pull off the heist of the century. Unfortunately for Johnny and Clyde's crew, Alana has a deadly weapon at her disposal – the monstrous slasher spirit known as Bakwas.",
        "popularity": 889.763,
...
{
  //get the all movie which are rated above 7 with title and vote_average
    const movies = myMovies.filter(movie => movie.vote_average > 7).map(movie => {
        return {
            title: movie.title,
